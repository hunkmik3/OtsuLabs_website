...
export const projects: ProjectData[] = [
    {
        id: 1,
        slug: 'pixelmon',
        client: 'Nova Thera: Initiation',
        projectTitle: 'Nova Thera: Initiation',
        scope: 'Character design, Storyboard, Color script, Lighting Mood, Script Writing, Concept art, Full production, Visual effects, Sound design',
        image: '/images/home/selected_works_1.png',
        date: '[OCTOBER, 2025]',
        heroVideo: '/images/projects/Nova%20Thera/novathrea_initiation.mp4',
        ...
        scopeImages: {
            top: [
                '/images/projects/Nova%20Thera/novatheraintiation1.png',
                '/images/projects/Nova%20Thera/novatheraintiation2.png',
            ],
            bottom: '/images/projects/Nova%20Thera/novatheraintiation3.png',
        },
        ...
        characterSheetImages: [
            { src: '/images/projects/images_global/nova model 1.png', label: '[NAME OF CHARACTER]' },
            { src: '/images/projects/images_global/nova model2 .png', label: '[NAME OF CHARACTER]' },
            { src: '/images/projects/images_global/novamodal3.png', label: '[NAME OF CHARACTER]' },
            { src: '/images/projects/images_global/nova model 4.png', label: '[NAME OF CHARACTER]' },
        ],
        explorationSlides: [
            { image: '/images/projects/images_global/dragon1%20.png', title: '[The Dragon Name]', description: 'A short process description goes here' },
            { image: '/images/projects/images_global/dragon%202.png', title: '[The Phoenix]', description: 'Creature exploration and iteration' },
            { image: '/images/projects/images_global/dragon3.png', title: '[The Serpent]', description: 'Final concept art for production' },
            { image: '/images/projects/images_global/dragon%204%20.png', title: '[The Guardian]', description: 'Boss character design exploration' },
            { image: '/images/projects/images_global/dragon%205.png', title: '[The Colossus]', description: 'Extended concept exploration' },
        ],
    },
    {
        id: 2,
